    ...
    return (
      ...
      >
          <div className="flex items-center justify-center w-full bg-indigo-950 rounded-[50px]" >
              ...
              {/*<div className="  relative rounded-[100px] z-1">*/}
              {/*    <div className="w-1/20 h-44 left-0 top-[156px] absolute bg-linear-to-b from-indigo-700 from-55% to-white rounded-[100px] to-125%" />*/}
          ...
          <div className="flex flex-col items-center justify-center absolute z-10 space-y-11.75">
              <h1 className="text-white text-6xl font-bold font-['Inter'] text-center leading-16 [text-shadow:0px_8px_8px_rgb(0_0_0/0.25)]">level up your VO</h1>
