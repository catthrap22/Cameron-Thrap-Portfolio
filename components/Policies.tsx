      ...
      >
          ...
          >
              {items.map((item) => (
                  ...
                  >
                      <AccordionTrigger className="text-2xl font-bold font-inter leading-6">{item.title}</AccordionTrigger>
                      <AccordionContent className="h-fit">{item.description}</AccordionContent>
                  </AccordionItem>
              ))}
          </Accordion>
</section>
