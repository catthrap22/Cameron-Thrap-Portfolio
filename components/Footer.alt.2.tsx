...
import {faFacebook, faImdb, faInstagram} from "@fortawesome/free-brands-svg-icons";
...
export default function Footer() {
    ...
    const handleCopy = async () => {
        try {
            ...
            await navigator.clipboard.writeText("" + "Coast To Coast Talent Group\n" + "                        " + "Director of Voiceover\n" + "                        " + "3350 Barham Blvd.\n" + "                        " + "Los Angeles, CA 90068");
            setCopied(true);
        ...
        >
            ...
            <div className="flex flex-row justify-center items-center space-x-4 pb-8">
                <div className="hidden md:block">
                    ...
                    <Image src="/src/CameronAdgencyLogo.png" alt="Coast to Coast Talent Group Logo" width={264}
                           height={148}/>
                </div>
                <div>
                ...
                <div className="font-inter text-xl lg:text-2xl font-bold text-white z-10 font-inter md:text-base
                 {/*text-center*/} space-y-4 text-center md:text-start">
                    {/*    here is the address for the agency and here is where we want to add a button as well that copies the address so they can look it up*/}
                    <div>
            ...
            <div className="p-8 w-full h-fit flex justify-between items-center flex-col-reverse md:flex-row">
